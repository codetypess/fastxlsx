...
export function buildDefinedNameXml(
    name: string,
    value: string,
...
export function insertDefinedNameIntoWorkbookXml(
    workbookXml: string,
    ...
    if (definedNamesTag) {
        ...
        return (
            workbookXml.slice(0, insertionIndex) +
            definedNameXml +
            workbookXml.slice(insertionIndex)
        );
    }
...
export function removeDefinedNameFromWorkbookXml(
    ...
    return rewriteDefinedNamesInWorkbookXml(workbookXml, (tag) => {
        ...
        const candidateLocalSheetId =
            candidateLocalSheetIdText === undefined ? null : Number(candidateLocalSheetIdText);
